...
func (_mock *MockEmailSender) Send(ctx context.Context, msg senders.Message) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, senders.Message) error); ok {
...
//   - ctx context.Context
//   - msg senders.Message
func (_e *MockEmailSender_Expecter) Send(ctx interface{}, msg interface{}) *MockEmailSender_Send_Call {
	return &MockEmailSender_Send_Call{Call: _e.mock.On("Send", ctx, msg)}
}

func (_c *MockEmailSender_Send_Call) Run(run func(ctx context.Context, msg senders.Message)) *MockEmailSender_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
		}
		var arg1 senders.Message
		if args[1] != nil {
			arg1 = args[1].(senders.Message)
		}
		run(
			arg0,
			arg1,
...
func (_c *MockEmailSender_Send_Call) RunAndReturn(run func(ctx context.Context, msg senders.Message) error) *MockEmailSender_Send_Call {
	_c.Call.Return(run)
	return _c
}
